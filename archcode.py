cell = {'collect_input': 0,
        'step': [['Protein', 'collect_input'],
                 ['Protein', 'step'],
                 ['Protein', 'get_output']],
        'update': [['Protein', 'set_loss'],
                   ['Protein', 'update']],
        'get_output': 0,
        }

protein = {'collect_input': 0,
           'step': 0,
           'set_loss': 0,
           'update': 0,
           'get_output': 0}

simulation = {'stimulation': [['Cell', 'collect_input'],
                              ['Cell', 'step'],
                              ['Cell', 'update'],
                              ['Cell', 'get_output']]
              }

classes_dict = {'Cell': cell,
                'Protein': protein,
